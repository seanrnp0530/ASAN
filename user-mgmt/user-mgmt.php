        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="px-12 py-2 bg-green-dark text-white">Role</th>
                    <th class="px-12 py-2 bg-green-dark text-white">Status</th>
                    <th class="px-12 py-2 bg-green-dark text-white">Verification</th>
