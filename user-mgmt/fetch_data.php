...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td class='px-12 py-2'>
            <form method='post' action='delete.php' style='display:inline-block;' onsubmit='return confirm(\"Are you sure you want to deactivate this user?\");'>
                <input type='hidden' name='id' value='" . htmlspecialchars($row['id']) . "'>
                <button type='submit' class='bg-red-500 hover:bg-red-900 text-white font-bold py-2 px-2 rounded'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='80' height='20' viewBox='0 0 24 24'>
